...
export default function UploadPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-gradient-to-br from-black via-gray-900 to-zinc-900">
      <div className="w-full max-w-xl bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-10 text-center relative">
        <div className="absolute top-4 right-4">
          <PaperClipIcon className="h-6 w-6 text-indigo-400" />
        </div>
        ...
        <button
          onClick={upload}
          className="mt-6 w-full py-4 bg-indigo-500 text-white rounded-xl font-semibold text-lg hover:bg-indigo-400 transition"
        >
          Upload & Analyze
        </button>
